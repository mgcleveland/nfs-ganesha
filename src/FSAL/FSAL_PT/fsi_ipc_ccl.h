...
int ccl_sys_acl_get_entry(acl_t           theacl,
                          int             entry_id,
                          acl_entry_t   * entry_p);
int ccl_sys_acl_get_tag_type(acl_entry_t     entry_d,
                             acl_tag_t     * tag_type_p);
int ccl_sys_acl_get_permset(acl_entry_t     entry_d,
                            acl_permset_t * permset_p);
void * ccl_sys_acl_get_qualifier(acl_entry_t     entry_d);
...
int ccl_sys_acl_delete_def_file(ccl_context_t * handle,
                                const char    * path);
int ccl_sys_acl_get_perm(acl_permset_t   permset,
                         acl_perm_t      perm);
int ccl_sys_acl_free_acl(acl_t posix_acl);
